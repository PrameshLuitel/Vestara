...
export default function Homepage() {
  ...
  return (
    <div className="flex flex-col items-center text-center p-4">
      <div className="relative w-full max-w-5xl mx-auto mb-12 p-4 min-h-[30vh] bg-background/50 backdrop-blur-sm rounded-lg overflow-hidden">
        <AnimatedHero />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 w-full max-w-5xl">
        {features.map((feature) => (
          <Card key={feature.name} className="text-left bg-card/60 backdrop-blur-lg border-border/30 text-card-foreground transition-all hover:border-primary/40">
            <CardHeader className="flex flex-row items-center justify-between pb-2">
              <CardTitle className="text-sm font-medium text-card-foreground">{feature.name}</CardTitle>
              {feature.icon}
            </CardHeader>
            <CardContent>
      ...
      <div className="mt-16 w-full max-w-5xl text-left">
          <h2 className="text-3xl font-bold font-headline mb-6 text-center text-foreground">The Mandate</h2>
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="text-left bg-card/60 backdrop-blur-lg border-border/30 text-card-foreground">
                <CardHeader>
                    <CardTitle className="text-card-foreground">Architecting Market Integrity</CardTitle>
                </CardHeader>
                <CardContent>
             ...
             <Card className="text-left bg-card/60 backdrop-blur-lg border-border/30 text-card-foreground">
                <CardHeader>
                    <CardTitle className="text-card-foreground">Forecasting the Future</CardTitle>
                </CardHeader>
                <CardContent>
